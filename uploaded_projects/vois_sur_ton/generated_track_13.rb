...
define :sleep_sample_0 do |x|
	if x < 27
		if ((x + 1) % 6 == 0 || (x + 1) % 8 == 0 || (x + 6) % 11 == 0 || (x + 5) % 11 == 0 || (x + 1) % 11 == 0 || (x + 2) % 12 == 0 || (x + 3) % 15 == 0)
			return true
		else 
			return false
		end
		...
		x = (x - 47)
		if ((x + 5) % 6 == 0 || (x + 1) % 7 == 0 || (x + 2) % 8 == 0 || (x + 8) % 10 == 0 || (x + 4) % 11 == 0)
			return true
		else 
			return false
		end
...
define :sleep_sample_4 do |x|
	if x < 27
		if ((x + 5) % 8 == 0 || (x + 2) % 13 == 0 || (x + 3) % 14 == 0 || x % 19 == 0)
			return true
		else 
			return false
		end
...
define :sleep_sample_7 do |x|
	if x < 27
		...
		x = (x - 47)
		if ((x + 4) % 8 == 0 || (x + 1) % 8 == 0 || (x + 6) % 9 == 0 || (x + 5) % 9 == 0 || (x + 8) % 10 == 0 || (x + 6) % 10 == 0 || (x + 10) % 11 == 0 || (x + 4) % 11 == 0)
			return true
		else 
			return false
		end
		...
		x = (x - 67)
		if (x % 7 == 0 || (x + 1) % 7 == 0 || (x + 3) % 8 == 0 || (x + 1) % 8 == 0 || x % 12 == 0)
			return true
		else 
			return false
		end
